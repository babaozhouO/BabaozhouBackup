...
Partial Class MainForm
	...
	Private Sub InitializeComponent()
		...
		IntroductionLabel.Size = New Size(502, 57)
		IntroductionLabel.TabIndex = 1
		IntroductionLabel.Text = "程序名称八宝粥的多MC服务端管理面板          作者:八宝粥" & vbCrLf & "简介:(多个)MC服务端管理面板" & vbCrLf & "Github仓库链接:https://github.com/babaozhouO/BBZ-MCServers-Manager"
		' 
		' LogsLabel
		' 
