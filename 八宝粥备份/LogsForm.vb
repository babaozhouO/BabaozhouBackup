...
Imports System.IO
Imports System.Text
Public Class 显示日志的窗口
    Private 日志处理器实例 As 日志处理功能
    Private Sub 显示日志的窗口_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        日志处理器实例 = New 日志处理功能()
        日志处理器实例.绑定文本框(Me.LogsRichTextBox)
        日志处理器实例.添加日志("[Success]外置日志显示窗口初始化成功", Color.Green)
    End Sub
    ...
    Public Sub New(主窗体 As MainForm)
        InitializeComponent()
        主窗口 = 主窗体
        Me.Owner = 主窗体
    End Sub
